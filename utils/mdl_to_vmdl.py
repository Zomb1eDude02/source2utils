...
def mdl_to_vmdl(contentdir):

    PATH_TO_CONTENT_ROOT = None # so python doesnt complain on import
    ...
    abspath = ''
    files = []
    PATH_TO_CONTENT_ROOT = str(contentdir).lower() # input("What folder would you like to convert? Valid Format: C:\\Steam\\steamapps\\Half-Life Alyx\\content\\tf\\models\\props_spytech\\: ").lower()
